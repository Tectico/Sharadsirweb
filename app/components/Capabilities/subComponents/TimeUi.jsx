...
const TimeUi = () => {
  const FeatureArray = [
    ...
    {
      id: 2,
      title: "View Tasks with Effort Overruns Highlighted",
      description:
        "Easily review all tasks along with their status and effort spent (in hours), and quickly spot any that exceed planned effort using the highlight feature",
      src: "https://cdn.dribbble.com/userupload/34672707/file/original-fb602955aa60ca6393c5520967f246a6.jpg?resize=1200x900&vertical=center",
    },
